            ...
            <div class="box-body">
              <table id="tbl_produk" class="table table-bordered table-striped tbl_produk">
                ...
                <tr>
                  ...
                  <th>Jumlah</th>
                  <th>
                    <a href="<?php echo base_urL()."index.php/transaksi/c_barang_keluar/add_data";?>"> 
                ...
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $row['no_barang_keluar']; ?></td>
                  ...
                  <td>
                    <a onclick="return konfirmasi()" href="<?php echo base_url()."index.php/transaksi/c_barang_keluar/do_delete/".$row['no_barang_keluar']; ?>"><button class="btn btn-danger btn-sm">DELETE</button></a>
                  </td>
